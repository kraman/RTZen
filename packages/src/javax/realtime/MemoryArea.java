...
public abstract class MemoryArea{
    ...
    public void enter(){
        //System.err.println( "RTSJ:  Enter in memory area ["+this.toString()+"]" );
        //Thread.dumpStack();
    ...
    public java.lang.Object newInstance( java.lang.Class type )
        throws java.lang.IllegalAccessException,
            java.lang.InstantiationException
    {
        //System.err.println( "RTSJ:  New object("+type+") in memory area ["+this.toString()+"]" );
        return type.newInstance();
    }

    public java.lang.Object newInstance( java.lang.reflect.Constructor c , java.lang.Object[] args )
        throws java.lang.IllegalAccessException,
            java.lang.InstantiationException
    {
        //System.err.println( "RTSJ:  New object("+c.getDeclaringClass()+") from constructor in memory area ["+this.toString()+"]" );
        try{
