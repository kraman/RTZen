...
//    pointcut send_request(edu.uci.ece.zen.orb.giop.RequestMessage obj):
//        execution(* edu.uci.ece.zen.orb.giop.RequestMessage.marshallHeader(..)) && target(obj);
//
//    before(edu.uci.ece.zen.orb.giop.RequestMessage obj): send_request(obj) {
//
//        if(clientInterceptors != null) {
//
...
//
//                    default:
//                        Logger.warn("Client interceptor of type " + type + " not found.");
//
//                }
//            }
