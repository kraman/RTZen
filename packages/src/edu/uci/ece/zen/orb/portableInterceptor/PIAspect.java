...
//    pointcut init(org.omg.CORBA.ORB this_orb, String[] argv,java.util.Properties props):
//            //execution(public void *..ORB.internalInit(..)) && args(param_orb,argv,props) && target(this_orb);
//            execution(public void edu.uci.ece.zen.orb.ORB.internalInit(..)) && args(argv,props) && target(this_orb);
//                //String[] argv,
//
...
//
//    //pre init
//    before(org.omg.CORBA.ORB this_orb, String[] argv,java.util.Properties props):init(this_orb, argv,props) {
//
...
//
//    //post init
//    after(org.omg.CORBA.ORB this_orb, String[] argv,java.util.Properties props):init(this_orb, argv,props) {
//
...
//        java.util.Enumeration props = edu.uci.ece.zen.sys.ZenProperties.propertyNames();
//        String nextProp = "";
