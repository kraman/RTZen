...
*/
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, RequestHeader value)
    {
        ...
        if(ZenProperties.devDbg) System.out.println("sc len: " + value.service_context.length());
        if(ZenProperties.devDbg) System.out.println("sc: " + value.service_context.decode());
