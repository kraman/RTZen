...
final public class IdNoHintStrategy {
    ...
    public static void create(char prefix, FString objectId, FString time,
            int poaIndex, int poaGenCount, FString okey_out) {
     ...
     * @return ObjectKey
     */
    public static void create(char prefix, FString poaPath, FString time,
            FString objectId, int poaIndex, int poaGenCount, FString okey_out) {
