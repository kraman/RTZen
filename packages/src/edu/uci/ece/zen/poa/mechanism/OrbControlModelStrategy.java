...
public final class OrbControlModelStrategy extends ThreadPolicyStrategy {
    ...
    /**
     * enter() methods defaults to no-op as the POA is multi-threaded and there
     * is no need to grab a lock.
     * 
     * @param invokeHandler
    ...
    /**
     * executed after return from critical section. Defaults to no-op as POA
     * multi-threaded
     * 
     * @param invokeHandler
     *            org.omg.CORBA.portable.InvokeHandler
    ...
    /**
     * Default synchronization blocks. Specialized in the Single-thread case.
     * Default to no-ops here.
     */
    public void enter() {
    }
