...
public class POA extends org.omg.CORBA.LocalObject implements
    ...
    public void init(final edu.uci.ece.zen.orb.ORB orb, String poaName,
     ...
     * in--&gt; ORBImpl scope --&gt; POAImpl region --ex in--&gt; ORBImpl scope
     * --&gt; TP Region
     * </p>
     * TP Thread: <br/>
     * <p>
    ...
    public byte[] servant_to_id(final org.omg.PortableServer.Servant p_servant)
         ...
         * r.addParam( p_servant ); r.addParam(
         * RealtimeThread.getCurrentMemoryArea() ); ExecuteInRunnable eir1 = new
         * ExecuteInRunnable(); eir1.init( poaMemoryArea , r );
         * ExecuteInRunnable eir2 = new ExecuteInRunnable(); eir2.init(
         * orb.orbImplRegion , eir1 ); try{ orb.parentMemoryArea.executeInArea(
         * eir2 ); }catch( Exception e ){ e.printStackTrace(); } switch(
         * r.exception ){ case -1: //no exception break; case 1: throw new
         * ServantNotActive(); case 2: throw new WrongPolicy(); } return
         * (byte[])r.retVal;
         */
    ...
    public org.omg.PortableServer.Servant reference_to_servant(
         ...
         * r.addParam( reference ); r.addParam(
         * RealtimeThread.getCurrentMemoryArea() ); ExecuteInRunnable eir1 = new
         * ExecuteInRunnable(); eir1.init( poaMemoryArea , r );
         * ExecuteInRunnable eir2 = new ExecuteInRunnable(); eir2.init(
         * orb.orbImplRegion , eir1 ); try{ orb.parentMemoryArea.executeInArea(
         * eir2 ); }catch( Exception e ){ e.printStackTrace(); } switch(
         * r.exception ){ case -1: //no exception break; case 1: throw new
         * ObjectNotActive(); case 2: throw new WrongPolicy(); case 3: throw new
         * WrongAdapter(); } return (Servant)r.retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public byte[] reference_to_id(final org.omg.CORBA.Object reference)
         ...
         * eir2 ); }catch( Exception e ){ e.printStackTrace(); } switch(
         * r.exception ){ case -1: //no exception break; case 1: throw new
         * WrongAdapter(); case 2: throw new WrongPolicy(); } return
         * (byte[])r.retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.PortableServer.Servant id_to_servant(final byte[] oid)
         ...
         * r.addParam( oid ); r.addParam( RealtimeThread.getCurrentMemoryArea() );
         * ExecuteInRunnable eir1 = new ExecuteInRunnable(); eir1.init(
         * poaMemoryArea , r ); ExecuteInRunnable eir2 = new
         * ExecuteInRunnable(); eir2.init( orb.orbImplRegion , eir1 ); try{
         * orb.parentMemoryArea.executeInArea( eir2 ); }catch( Exception e ){
         * e.printStackTrace(); } switch( r.exception ){ case -1: //no exception
         * break; case 1: throw new ObjectNotActive(); case 2: throw new
         * WrongPolicy(); } return (Servant)r.retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.CORBA.Object id_to_reference(final byte[] oid)
         ...
         * e.printStackTrace(); } switch( r.exception ){ case -1: //no exception
         * break; case 1: throw new ObjectNotActive(); case 2: throw new
         * WrongPolicy(); } return (org.omg.CORBA.Object)r.retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public byte[] activate_object(org.omg.PortableServer.Servant p_servant)
         ...
         * eir2 ); }catch( Exception e ){ e.printStackTrace(); } switch(
         * r.exception ){ case -1: //no exception break; case 1: throw new
         * ServantAlreadyActive(); case 2: throw new WrongPolicy(); } return
         * (byte[])r.retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public void activate_object_with_id(final byte[] id,
         ...
         * r.addParam( id ); r.addParam( p_servant ); r.addParam(
         * RealtimeThread.getCurrentMemoryArea() ); ExecuteInRunnable eir1 = new
         * ExecuteInRunnable(); eir1.init( poaMemoryArea , r );
         * ExecuteInRunnable eir2 = new ExecuteInRunnable(); eir2.init(
         * orb.orbImplRegion , eir1 ); try{ orb.parentMemoryArea.executeInArea(
         * eir2 ); }catch( Exception e ){ e.printStackTrace(); } switch(
         * r.exception ){ case -1: //no exception break; case 1: throw new
         * ServantAlreadyActive(); case 2: throw new ObjectAlreadyActive(); case
         * 3: throw new WrongPolicy(); }
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.PortableServer.POA create_POA(String adapter_name,
        ...
        /*
         * synchronized (createDestroyPOAMutex) { edu.uci.ece.zen.poa.POA child =
         * (edu.uci.ece.zen.poa.POA) this.theChildren.get(adapter_name); if
         * (child != null) { if (!(child.getState() ==
         * POA.DESTRUCTION_APPARANT)) { throw new
         * org.omg.PortableServer.POAPackage.AdapterAlreadyExists(); } if (
         * this.disableCreatePOA && !poaState == POA.DESTRUCTION_APPARANT ) {
         * throw new BAD_INV_ORDER(17, CompletionStatus.COMPLETED_NO); } else {
         * this.disableCreatePOA = false; } } this.poaState = POA.CREATING; POA
         * newPoa = POA.instance(); newPoa.init( orb , adapter_name , policies ,
         * this , a_POAManager ); theChildren.put(adapter_name, child); poaState =
         * POA.CREATION_COMPLETE; return child; }
         */

        throw new org.omg.CORBA.NO_IMPLEMENT();
        /*
         * POA newPoa = POA.instance(); newPoa.init( orb , adapter_name ,
         * policies , this , a_POAManager ); theChildren.put(adapter_name,
         * child); poaState = POA.CREATION_COMPLETE; return child;
         */
    }

    public org.omg.PortableServer.POA find_POA(
            final java.lang.String adapter_name, final boolean activate_it)
            throws AdapterNonExistent {
        /*
         * Object poa = theChildren.get(adapter_name); if( poa != null ) return
    ...
    public void destroy(final boolean etherealize_objects,
        ...
        /*
         * if (wait_for_completion) { ThreadSpecificPOACurrent current =
         * POATSS.tss.getCurrent(); if (current != null &&
         * ((edu.uci.ece.zen.poa.POA) current.getPOA()).getORB() == this.orb) {
         * throw new org.omg.CORBA.BAD_INV_ORDER("The destroy is unsuccessful as
         * the Current" + "thread is in the InvocationContext", 3,
         * CompletionStatus.COMPLETED_NO); } } synchronized
         * (createDestroyPOAMutex) { this.disableCreatePOA = true; if
         * (((POAManager) poaManager).isInActive()) { this.processingState =
         * POA.INACTIVE; } else { this.processingState = POA.DISCARDING; } // if
         * called multiple_times the first time is the etherealize param if
         * (poaState < POA.DESTRUCTION_IN_PROGRESS) { this.etherealize =
         * etherealize_objects; } this.poaState = POA.DESTRUCTION_IN_PROGRESS;
         * Object[] e = this.the_children.getObjects(); for (int i = 0; i <
         * e.length; i++) { if( e[i] != null ) ((POA)e[i]).destroy(etherealize,
         * wait_for_completion); } // Remove the POA from the
         * POAServerRequestHandler and also from the // list of childrenPOA
         * maintained the by Parent if (this.parent != null) { POARunnable r =
         * new POARunnable(POARunnable.REMOVE_FROM_PARENT); r.addParam( poa );
         * ExecuteInRunnable eir1 = new ExecuteInRunnable(); eir1.init(
         * poaMemoryArea , r ); ExecuteInRunnable eir2 = new
         * ExecuteInRunnable(); eir2.init( orb.orbImplRegion , eir1 ); try{
         * orb.parentMemoryArea.executeInArea( eir2 ); }catch( Exception e ){
         * e.printStackTrace(); } } this.serverRequestHandler.remove(this);
         * ((edu.uci.ece.zen.poa.POAManager) this.poaManager).unRegister(this); //
         * Clear the list of children for this POA this.theChildren.empty(); //
         * Wait for the Apparent Destruction of the POA if
         * (this.numberOfCurrentRequests.get() != 0) {
         * this.numberOfCurrentRequests.waitForCompletion(); } // At this point
         * the Apparent Destruction of the POA has occured. // Ethrealize the
         * servants for each activeObject in the AOM this.poaState =
         * POA.DESTRUCTION_APPARANT; POARunnable r = new
         * POARunnable(POARunnable.DESTROY); r.addParam( poa );
         * ExecuteInRunnable eir1 = new ExecuteInRunnable(); eir1.init(
         * poaMemoryArea , r ); ExecuteInRunnable eir2 = new
         * ExecuteInRunnable(); eir2.init( orb.orbImplRegion , eir1 ); try{
         * orb.parentMemoryArea.executeInArea( eir2 ); }catch( Exception e ){
         * e.printStackTrace(); } // At this point the destruction of the POA
         * has been completed // notify any threads that could be waiting for
         * this POA to be // destroyed this.poaState = POA.DESTRUCTION_COMPLETE;
         * ORB.freeScopedRegion( this.poaMemoryArea ); poaManager.free();
    ...
    public org.omg.PortableServer.ImplicitActivationPolicy create_implicit_activation_policy(
        ...
        /*
         * return
         * this.serverRequestHandler.create_implicit_activation_policy(value);
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.PortableServer.ServantRetentionPolicy create_servant_retention_policy(
        ...
        /*
         * return
         * this.serverRequestHandler.create_servant_retention_policy(value);
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.PortableServer.RequestProcessingPolicy create_request_processing_policy(
        ...
        /*
         * return
         * this.serverRequestHandler.create_request_processing_policy(value);
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.PortableServer.POA[] the_children() {
        /*
         * Object[] objs = theChildren.getObjects(); POA[] poas = new
         * POA[objs.length]; for( int i=0;i <objs.length;i++ ) poas[i] = (POA)
         * objs[i]; return poas;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public ServantManager get_servant_manager() throws WrongPolicy {
        /*
         * POARunnable r = getPOARunnable(); r.init(
         * POARunnable.GET_SERVANT_MANAGER , null , null , null , null , null ,
         * null , null ); poaMemoryArea.enter(r); Exception ex =
         * r.getException(); org.omg.PortableServer.ServantManager retVal =
         * (org.omg.PortableServer.ServantManager) r.getRetVal();
         * returnPOARunnable( r ); if( ex != null ) throw ex; return retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public void set_servant_manager(
        ...
        /*
         * POARunnable r = getPOARunnable(); r.init(
         * POARunnable.SET_SERVANT_MANAGER , imgr , null , null , null , null ,
         * null , null ); poaMemoryArea.enter(r); Exception ex =
    ...
    public org.omg.CORBA.Object create_reference(final String intf)
            throws org.omg.PortableServer.POAPackage.WrongPolicy {
        /*
         * org.omg.CORBA.Object retVal; POARunnable r = getPOARunnable();
         * r.init( POARunnable.CREATE_REFERENCE , intf , curMemArea , null ,
         * null , null , null , null ); poaMemoryArea.getCurrentMemoryArea();
         * Exception ex = r.getException(); retVal = r.getRetVal();
         * returnPOARunnable( r ); if( ex != null ) throw ex; return retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.CORBA.Object create_reference_with_id(final byte[] oid,
        ...
        /*
         * org.omg.CORBA.Object retVal; POARunnable r = getPOARunnable();
         * r.init( POARunnable.CREATE_REFERENCE_WITH_ID , intf , oid ,
         * curMemArea , null , null , null , null );
         * poaMemoryArea.getCurrentMemoryArea(); Exception ex =
         * r.getException(); retVal = r.getRetVal(); returnPOARunnable( r ); if(
         * ex != null ) throw ex; return retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    }
    ...
    public org.omg.CORBA.Policy[] policy_list() {
        /*
         * org.omg.CORBA.Policy[] retVal; POARunnable r = getPOARunnable();
         * r.init( POARunnable.GET_POLICY_LIST ,
         * RealtimeThread.getCurrentMemoryArea() , null , null , null , null ,
         * null , null ); poaMemoryArea.getCurrentMemoryArea(); Exception ex =
         * r.getException(); retVal = r.getRetVal(); returnPOARunnable( r ); if(
         * ex != null ) throw ex; return retVal;
         */
        throw new org.omg.CORBA.NO_IMPLEMENT();
    ...
    POA getChildPOA(String poaName) {
        /*
         * POA child = (POA) this.theChildren.get(poaName); if (child == null ||
         * child.getStatus() == POA.DESTRUCTION_APPARANT) { if (adapterActivator ==
         * null) { if( POA.objNotExistException == null ){
         * POA.objNotExistException = ImmortalMemory.instance().newInstance(
         * OBJECT_NOT_EXIST.class ); } throw POA.objNotExistException; } if
         * (((POAManager) poaManager).isDiscarding()) { if(
         * POA.parentDiscardTransientException == null ){
         * POA.parentDiscardTransientException =
         * ImmortalMemory.instance().newInstance( ParentDiscardTRANSIENT.class ); }
         * throw parentDiscardTransientException; } if (((POAManager)
         * poaManager).isInActive()) { throw new
         * org.omg.CORBA.OBJ_ADAPTER("Parent POA inactive"); } // one also needs
         * to check for holding state and take action if (((POAManager)
         * poaManager).isHolding()) { throw new org.omg.CORBA.TRANSIENT("Parent
         * POA in holding state:Cannot Activate Child POA", 1,
         * org.omg.CORBA.CompletionStatus.COMPLETED_NO); } // The POA is
         * active.. Serailize the calls if Single threaded childMemory.enter(new
         * Runnable(){ public void run(){
         * (((POAImpl)childMemory.getPortal()).getThreadPolicyStrategy()).enter(); }
         * }); //this.threadPolicyStrategy.enter(); boolean success =
         * the_activator().unknown_adapter(this, poaName); childMemory.enter(new
         * Runnable() { public void run(){ (
         ...
         * org.omg.CORBA.INTERNAL("unknown_adapter operation", 0,
         * CompletionStatus.COMPLETED_NO); } } throw new
         * org.omg.CORBA.OBJECT_NOT_EXIST("POA activation failed"); } return
         * child;
         */throw new org.omg.CORBA.NO_IMPLEMENT();
    }
}
