/* --------------------------------------------------------------------------*
 * $Id: POAManager.java,v 1.1 2003/11/26 22:26:25 nshankar Exp $
 *--------------------------------------------------------------------------*/
...
/**
 * The class <code>POAManager</code>
 * is ZEN specific implementation of the CORBA POA Manager
 *
...
import edu.uci.ece.zen.orb.InvalidEndpoint;
import edu.uci.ece.zen.orb.ProtocolFactoryList;
import edu.uci.ece.zen.orb.protocols.AcceptorRegistry;
import edu.uci.ece.zen.orb.protocols.ProtocolFactory;

/**
 * This class POAManager is managing the POA operations. This class activates,deactivates the POA. It is also responsible for handelling the requests -    * queing and discarding of request.
 */
 ...
 */
    public static void checkPOAManagerState(org.omg.PortableServer.POAManager manager) {
        ...
        // would have to do something correct here!!
