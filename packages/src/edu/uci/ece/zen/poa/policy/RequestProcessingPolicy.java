...
/**
 * The class <code>RequestProcessingPolicy</code> is the ZEN specific
...
public class RequestProcessingPolicy extends org.omg.CORBA.LocalObject
    ...
    public static final RequestProcessingPolicy DefaultServant = new RequestProcessingPolicy(
            RequestProcessingPolicyValue.USE_DEFAULT_SERVANT);

    public static final RequestProcessingPolicy ServantManager = new RequestProcessingPolicy(
