...
/**
 * The class <code>ThreadPolicy</code> is ZEN specific implementation of CORBA
 * ThreadPolicy
 * 
...
public class ThreadPolicy extends org.omg.CORBA.LocalObject implements
        org.omg.PortableServer.ThreadPolicy {

    public static final ThreadPolicy OrbControlled = new ThreadPolicy();

    public static final ThreadPolicy SingleThreaded = new ThreadPolicy(
            ThreadPolicyValue.SINGLE_THREAD_MODEL);

    public static final ThreadPolicy MainThreaded = new ThreadPolicy(
