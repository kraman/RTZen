/*
 * File: SyncMap.java Originally written by Doug Lea and released into the
...
public class SyncMap implements Map {
    protected final Map c_; // Backing
    ...
    /**
     * Create a new SyncMap protecting the given map, and using the given sync
     * to control both reader and writer methods. Common, reasonable choices for
     * the sync argument include Mutex, ReentrantLock, and Semaphores
     * initialized to 1.
     */
    ...
    /**
     * Create a new SyncMap protecting the given map, and using the given
    ...
    /**
     * Create a new SyncMap protecting the given map, and using the given pair
