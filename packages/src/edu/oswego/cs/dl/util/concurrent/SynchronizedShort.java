/*
 * File: SynchronizedShort.java Originally written by Doug Lea and released into
...
public class SynchronizedShort extends SynchronizedVariable implements
        Comparable,Cloneable {

    protected short value_;

    /**
     * Make a new SynchronizedShort with the given initial value, and using its
     * own internal lock.
     */
    ...
    /**
     * Make a new SynchronizedShort with the given initial value, and using the
     * supplied lock.
     */
    ...
    /**
     * Atomically swap values with another SynchronizedShort. Uses
     * identityHashCode to avoid deadlock when two SynchronizedShorts attempt to
