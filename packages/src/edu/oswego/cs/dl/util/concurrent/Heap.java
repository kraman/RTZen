/*
 * File: Heap.java Originally written by Doug Lea and released into the public
 ...
 * dl Refactored from BoundedPriorityQueue
 */
...
/**
 * A heap-based priority queue, without any concurrency control (i.e., no
 * blocking on empty/full states). This class provides the data structure
 * mechanics for BoundedPriorityQueue.
 * <p>
 * The class currently uses a standard array-based heap, as described in, for
 * example, Sedgewick's Algorithms text. All methods are fully synchronized. In
 * the future, it may instead use structures permitting finer-grained locking.
 * <p>[ <a
...
public class Heap {
    protected Object[] nodes_; // the tree nodes, packed into an
