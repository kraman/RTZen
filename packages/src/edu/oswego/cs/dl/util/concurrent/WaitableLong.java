/*
 * File: WaitableLong.java Originally written by Doug Lea and released into the
...
public class WaitableLong extends SynchronizedLong {
    ...
    /**
     * Make a new WaitableLong with the given initial value, and using its own
     * internal lock.
     */
    ...
    /**
     * Make a new WaitableLong with the given initial value, and using the
     * supplied lock.
     */
