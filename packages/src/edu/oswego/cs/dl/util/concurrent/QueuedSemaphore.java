/*
 * File: QueuedSemaphore.java Originally written by Doug Lea and released into
 ...
 * with longs 24Aug1999 dl release(n): screen arguments
 */
...
public abstract class QueuedSemaphore extends Semaphore {
    ...
    protected synchronized WaitQueue.WaitNode getSignallee() {
        ...
        if (w == null) {
            ++permits_;
        } // if none, inc permits for new arrivals
        return w;
    }
