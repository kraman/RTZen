/*
 * File: SyncList.java Originally written by Doug Lea and released into the
...
/**
 * SyncLists wrap Sync-based control around java.util.Lists. They support the
 * following additional reader operations over SyncCollection: hashCode, equals,
 * get, indexOf, lastIndexOf, subList. They support additional writer operations
 * remove(int), set(int), add(int), addAll(int). The corresponding listIterators
...
public class SyncList extends SyncCollection implements List {
    ...
    /**
     * Create a new SyncList protecting the given collection, and using the
     * given sync to control both reader and writer methods. Common, reasonable
     * choices for the sync argument include Mutex, ReentrantLock, and
    ...
    /**
     * Create a new SyncList protecting the given list, and using the given
     * ReadWriteLock to control reader and writer methods.
     */
    ...
    /**
     * Create a new SyncList protecting the given list, and using the given pair
     * of locks to control reader and writer methods.
     */
    ...
    public List subList(int fromIndex, int toIndex) {
        ...
        try {
            return new SyncList(baseList().subList(fromIndex, toIndex), rd_,
                    wr_);
        } finally {
            afterRead(wasInterrupted);
        }
    ...
    public ListIterator listIterator(int index) {
        ...
        try {
            return new SyncCollectionListIterator(baseList()
                    .listIterator(index));
        } finally {
            afterRead(wasInterrupted);
        }
