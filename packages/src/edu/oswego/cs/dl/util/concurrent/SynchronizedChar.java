/*
 * File: SynchronizedChar.java Originally written by Doug Lea and released into
...
public class SynchronizedChar extends SynchronizedVariable implements
        Comparable,Cloneable {

    protected char value_;

    /**
     * Make a new SynchronizedChar with the given initial value, and using its
     * own internal lock.
     */
    ...
    /**
     * Make a new SynchronizedChar with the given initial value, and using the
     * supplied lock.
     */
    ...
    /**
     * Atomically swap values with another SynchronizedChar. Uses
     * identityHashCode to avoid deadlock when two SynchronizedChars attempt to
