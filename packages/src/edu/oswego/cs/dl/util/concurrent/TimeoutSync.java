/*
 * File: TimeoutSync.java Originally written by Doug Lea and released into the
...
/**
 * A TimeoutSync is an adaptor class that transforms all calls to acquire to
 * instead invoke attempt with a predetermined timeout value.
 * <p>
 * <b>Sample Usage </b>. A TimeoutSync can be used to obtain Timeouts for locks
 * used in SyncCollections. For example:
 * 
 * <pre>
...
public class TimeoutSync implements Sync {
    ...
    /**
     * Create a TimeoutSync using the given Sync object, and using the given
     * timeout value for all calls to acquire.
     */
