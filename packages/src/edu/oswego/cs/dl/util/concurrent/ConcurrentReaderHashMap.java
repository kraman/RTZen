/*
 * File: ConcurrentReaderHashMap Written by Doug Lea. Adapted from JDK1.2
 * HashMap.java and Hashtable.java which carries the following copyright:
 * Copyright 1997 by Sun Microsystems, Inc., 901 San Antonio Road, Palo Alto,
 * California, 94303, U.S.A. All rights reserved. This software is the
 * confidential and proprietary information of Sun Microsystems, Inc.
 * ("Confidential Information"). You shall not disclose such Confidential
 * Information and shall use it only in accordance with the terms of the license
 * agreement you entered into with Sun. History: Date Who What 28oct1999 dl
 * Created 14dec1999 dl jmm snapshot 19apr2000 dl use barrierLock 12jan2001 dl
 * public release
 */
 ...
 * </pre>
 * 
 * Instead, just take advantage of the fact that put returns null if the key was
...
public class ConcurrentReaderHashMap extends AbstractMap implements Map,
     ...
     * or 11 (whichever is greater), and a default load factor.
     */
            ...
            if (e == null) {
                ...
                synchronized (this) {
                    ...
                    if (first == tab[index] && oldValue != null) {
                        ...
                        // retry if wrong list or lost race against concurrent
                        // remove
                        return sput(key, value, hash);
                    }
                }
    ...
    public Object remove(Object key) {
        ...
        /*
         * Strategy: Find the entry, then 1. Set value field to null, to force
         * get() to retry 2. Rebuild the list without this entry. All entries
         * following removed node can stay in list, but all preceeding ones need
         * to be cloned. Traversals rely on this strategy to ensure that
        ...
        for (;;) {
            ...
            if (e == null) {
                ...
                synchronized (this) {
                    ...
                    if (first != tab[index] || oldValue == null) { return sremove(
                            key, hash); }
                    e.value = null;
                    count--;
