/*
 * File: SynchronizedRef.java Originally written by Doug Lea and released into
...
/**
 * A simple class maintaining a single reference variable that is always
 * accessed and updated under synchronization.
 * <p>
 * <p>[ <a
...
public class SynchronizedRef extends SynchronizedVariable {
    ...
    /**
     * Create a SynchronizedRef initially holding the given reference and using
    ...
    /**
     * Make a new SynchronizedRef with the given initial value, and using the
     * supplied lock.
     */
    ...
    /**
     * Atomically swap values with another SynchronizedRef. Uses
     * identityHashCode to avoid deadlock when two SynchronizedRefs attempt to
