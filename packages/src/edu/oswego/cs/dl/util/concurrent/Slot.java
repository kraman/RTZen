/*
 * File: Slot.java Originally written by Doug Lea and released into the public
 ...
 * dl Create public version 25aug1998 dl added peek
 */
 ...
 * efficient and controllable than using other bounded buffers implementations
 * with capacity of 1.
 * <p>
 * Among other applications, Slots can be convenient in token-passing designs:
 * Here. the Slot holds a some object serving as a token, that can be obtained
