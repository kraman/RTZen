/*
 * File: FutureResult.java Originally written by Doug Lea and released into the
...
public class FutureResult {
     ...
     * 
     * @param function -
     *            a Callable object whose result will be held by this
     *            FutureResult.
     ...
     *                if the operation producing the value encountered an
     *                exception.
     */
     ...
     * 
     * @param ex
     *            The exception. It will be reported out wrapped within an
     *            InvocationTargetException
     */
