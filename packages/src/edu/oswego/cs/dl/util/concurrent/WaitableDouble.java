/*
 * File: WaitableDouble.java Originally written by Doug Lea and released into
...
public class WaitableDouble extends SynchronizedDouble {
    ...
    /**
     * Make a new WaitableDouble with the given initial value, and using its own
     * internal lock.
     */
    ...
    /**
     * Make a new WaitableDouble with the given initial value, and using the
     * supplied lock.
     */
