/*
 * File: WaitableFloat.java Originally written by Doug Lea and released into the
...
public class WaitableFloat extends SynchronizedFloat {
    ...
    /**
     * Make a new WaitableFloat with the given initial value, and using its own
     * internal lock.
     */
    ...
    /**
     * Make a new WaitableFloat with the given initial value, and using the
     * supplied lock.
     */
