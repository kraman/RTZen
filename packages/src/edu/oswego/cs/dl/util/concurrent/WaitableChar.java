/*
 * File: WaitableChar.java Originally written by Doug Lea and released into the
...
public class WaitableChar extends SynchronizedChar {
    ...
    /**
     * Make a new WaitableChar with the given initial value, and using its own
     * internal lock.
     */
    ...
    /**
     * Make a new WaitableChar with the given initial value, and using the
     * supplied lock.
     */
