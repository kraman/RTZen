/*
 * File: ConditionVariable.java Originally written by Doug Lea and released into
...
/**
 * This class is designed for fans of POSIX pthreads programming. If you
 * restrict yourself to Mutexes and CondVars, you can use most of your favorite
 * constructions. Don't randomly mix them with synchronized methods or blocks
 * though.
 * <p>
 * Method names and behavior are as close as is reasonable to those in POSIX.
 * <p>
 * <b>Sample Usage. </b> Here is a full version of a bounded buffer that
 * implements the BoundedChannel interface, written in a style reminscent of
 * that in POSIX programming books.
 * 
 * <pre>
...
public class CondVar {
     ...
     * 
     * @param mutex
     *            A non-reentrant mutual exclusion lock. Standard usage is to
     *            supply an instance of <code>Mutex</code>, but, for example,
     *            a Semaphore initialized to 1 also works. On the other hand,
     *            many other Sync implementations would not work here, so some
     *            care is required to supply a sensible synchronization object.
     *            In normal use, the mutex should be one that is used for
     *            <em>all</em> synchronization of the object using the
     *            CondVar. Generally, to prevent nested monitor lockouts, this
     ...
     * momentarily releases the mutex. The mutex is always held upon return,
     * even if interrupted.
     * 
     * @param msecs
