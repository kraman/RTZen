/*
 * File: SynchronizedInt.java Originally written by Doug Lea and released into
...
public class SynchronizedInt extends SynchronizedVariable implements
        Comparable,Cloneable {

    protected int value_;

    /**
     * Make a new SynchronizedInt with the given initial value, and using its
     * own internal lock.
     */
    ...
    /**
     * Make a new SynchronizedInt with the given initial value, and using the
     * supplied lock.
     */
    ...
    /**
     * Atomically swap values with another SynchronizedInt. Uses
     * identityHashCode to avoid deadlock when two SynchronizedInts attempt to
