/*
 * File: SemaphoreControlledChannel.java Originally written by Doug Lea and
 ...
 * History: Date Who What 16Jun1998 dl Create public version 5Aug1998 dl
...
public abstract class SemaphoreControlledChannel implements BoundedChannel {
    ...
    /**
     * Create a channel with the given capacity and default semaphore
     * implementation
     * 
    ...
    /**
     * Create a channel with the given capacity and semaphore implementations
     * instantiated from the supplied class
     * 
     * @exception IllegalArgumentException
     *                if capacity less or equal to zero.
    ...
    /**
     * Return the number of elements in the buffer. This is only a snapshot
     * value, that may change immediately after returning.
     */
