/*
 * File: WaitableInt.java Originally written by Doug Lea and released into the
 ...
 * Who What 23Jun1998 dl Create public version
 */

package edu.oswego.cs.dl.util.concurrent;

/**
 * A class useful for offloading waiting and signalling operations on single int
 * variables.
 * <p>
 * <p>[ <a
...
public class WaitableInt extends SynchronizedInt {
    ...
    /**
     * Make a new WaitableInt with the given initial value, and using its own
     * internal lock.
     */
    ...
    /**
     * Make a new WaitableInt with the given initial value, and using the
     * supplied lock.
     */
