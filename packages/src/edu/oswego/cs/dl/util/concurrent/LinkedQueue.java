/*
 * File: LinkedQueue.java Originally written by Doug Lea and released into the
 ...
 * Who What 11Jun1998 dl Create public version 25aug1998 dl added peek 10dec1998
 * dl added isEmpty 10oct1999 dl lock on node object to ensure visibility
 */
 ...
 * between puts and takes when the queue is not empty. Normally a put and a take
 * can proceed simultaneously. (Although it does not allow multiple concurrent
 * puts or takes.) This class tends to perform more efficently than other
 * Channel implementations in producer/consumer applications.
 * <p>[ <a
