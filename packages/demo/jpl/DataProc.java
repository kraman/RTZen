...
class DataProc{
    ...
    public static void main(String[] args){
	    try{
		    int FACTOR = 1000000; //Specify the unit of the time
		    ...
		    for(int i = 0; i < v2.size();i++){
			    if(i%2==1){
				    ...
				    v2Proc.addElement(new Double((d1-d2)*FACTOR));
			    }
		    }
		    ...
		    for(int i = 0; i < v1.size();i++){
			    if(i%2==1){
				    ...
				    v1Proc.addElement(new Double((d1-d2)*FACTOR));
		    ...
		    PrintWriter out1 = new PrintWriter(new BufferedWriter(new FileWriter("timeRecords.1.3.3.128.txt")));
		    PrintWriter out2 = new PrintWriter(new BufferedWriter(new FileWriter("timeRecords.1.1.1.128.txt")));
