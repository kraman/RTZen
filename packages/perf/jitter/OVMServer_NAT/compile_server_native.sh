...
$OVMHOME/OpenVM_bin/bin/gen-ovm -engine=j2c -threads=RealtimeJVM -model=MostlyCopyingRegions-B_M_F_H  -app-methods-live -classpath=$RTZENHOME/lib/RTZen.jar:$RTZENHOME/lib/perf_world.jar -main=perf.jitter.Server
#
#. ./bin/prepare.sh
