...
public abstract class OutputStream extends java.io.OutputStream {
    ...
    /**
     * Abstract declaration, writes the Any <code>any</code> to the output
     * stream.
     */
    public abstract void write_any(org.omg.CORBA.Any any);

    /**
     * Abstract declaration, writes the TypeCode <code>value</code> to this
     * output stream.
     * 
     * @param value
     *            TypeCode to write to outputstream.
     */
