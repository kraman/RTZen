...
abstract public class ORB {
    ...
    private static final String getPropertyValue(String property, java.util.Properties props) {
    ...
    public synchronized static ORB init() {
       ...
       String orbClassName = ORB.getPropertyValue(ORB.ORB_SINGLETON_CLASS_PROPERTY,
                null);
    ...
    public static ORB init(String[] args, java.util.Properties props) {
        ...
        if (orbClassName == null) {
            System.err.println("Undefined property: " + ORB.ORB_CLASS_PROPERTY
                    + " Unable to create the Singleton ORB class");
        }
        ORB orb = null;
        if ( orbClassName.equals("edu.uci.ece.zen.orb.ORB"))
        {
        	orb = edu.uci.ece.zen.orb.ORB.init(args,props);
                return orb;
        }

        try {
            orb = (ORB) ORB.createInstance(orbClassName);
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(-1);
        }
    ...
    public static ORB init(java.applet.Applet app, java.util.Properties props) {
        ...
        if ( orbClassName.equals("edu.uci.ece.zen.orb.ORB"))
        {
        	orb = edu.uci.ece.zen.orb.ORB.init(app,props);
                return orb;
        }
