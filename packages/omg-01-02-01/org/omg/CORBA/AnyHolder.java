...
final public class AnyHolder implements org.omg.CORBA.portable.Streamable {
    ...
    public void _read(org.omg.CORBA.portable.InputStream is) {// ajc value = is.read_any();
    }

    public void _write(org.omg.CORBA.portable.OutputStream os) {// ajc  os.write_any(value);
    }
