...
/*******************************************************************************
 * *** ORB-vendors shall provide a complete implementation of the class by
 * extending it with a vendor-specific class which provides "real"
 * implementations for all the methods. E.g. package
 * com.acme_orb_vendor.CORBA_2_3; public class ORB extends org.omg.CORBA_2_3 {
 * ... } In order to be conformant the class shall support the signatures
 * specified here, but will have an orb-specific implementation. The class may
 * support additional vendor specific functionality.
 ******************************************************************************/
