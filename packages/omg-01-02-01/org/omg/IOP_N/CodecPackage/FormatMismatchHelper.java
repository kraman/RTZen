...
public class FormatMismatchHelper {
    private static org.omg.CORBA.TypeCode _type = null; // org.omg.CORBA.ORB.init().create_struct_tc(org.omg.IOP_N.CodecPackage.FormatMismatchHelper.id(),"FormatMismatch",new
    ...
    public static org.omg.IOP_N.CodecPackage.FormatMismatch read(
    ...
    public static void write(org.omg.CORBA.portable.OutputStream out,
            org.omg.IOP_N.CodecPackage.FormatMismatch s) {
        out.write_string(id());
    }
}