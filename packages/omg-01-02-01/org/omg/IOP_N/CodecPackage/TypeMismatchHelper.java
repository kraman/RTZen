...
public class TypeMismatchHelper {
    private static org.omg.CORBA.TypeCode _type = null; // org.omg.CORBA.ORB.init().create_struct_tc(org.omg.IOP_N.CodecPackage.TypeMismatchHelper.id(),"TypeMismatch",new
    ...
    public static org.omg.IOP_N.CodecPackage.TypeMismatch read(
    ...
    public static void write(org.omg.CORBA.portable.OutputStream out,
            org.omg.IOP_N.CodecPackage.TypeMismatch s) {
        out.write_string(id());
    }
}